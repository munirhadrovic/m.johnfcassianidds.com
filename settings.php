<?php
	$adresa="6800 Main Street Suite 211 Downers Grove Illinois 60516"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=6308528855;// Broj koji se poziva na dugme CALL US
